    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const readData = async (id) => {
            try {
                ...
                if (!doc) return null;
                const converted = convertBinaryToBuffer(doc);
                // un-wrap jika ada field value
                return Object.prototype.hasOwnProperty.call(converted, "value")
                    ? converted.value
                    : converted;
            } catch (error) {
